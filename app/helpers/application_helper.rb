    ...
    def team
      {
        row1: [
          ...
          },
          {
            ...
            image: "12-leia.png",
            cv: <<-HTML
              Luke's sister has long fallen to the dark side of the force. But deep inside (and unknown to herself) the spark of love for her brother is still glowing.
              <small>
              Cuddly: <i class="fa fa-star"></i> 
              Playful: <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> 
              Wild: <i class="fa fa-star"></i> <i class="fa fa-star"></i> 
          ...
          {
            name: "Valentina",
            title: "Little Princess | Persian",
            image: "04-wawa.png",
            cv: <<-HTML
              Valentina's primary weapon is her cuteness and she uses it to full effect. She likes dancing, prodding people with her paws, and filling the Galaxy with joy.
              <small>
              Cuddly: <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> 
              Playful: <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> 
              Wild: <i class="fa fa-star"></i> <i class="fa fa-star"></i> 
