...
HTML
          },
          {
            ...
            cv: <<-HTML
Retired from the Central African government where he rendered service in a number of minister and director posts, David Zokoe has always been implicated in charity and is burning to bring change to the situation for the people of his very poor country. David presides international NGO’s based in CAR, that are currently working on agricultural education as well as medical help for remote villages in the country. David is also helping to manage a foster home for displaced children and providing them with educational services in the capital.
        ...
        advisory_board: [
          {
            ...
            cv: <<-HTML
Jean Baptiste has been involved in the conservation of the Central African Wildlife for more than two decades. After finishing his studies in West Africa he started working by the early 90’s for the EU project ‘Developpement de la Region du Nord de la Centrafrique’. He held a number of positions in this domain, including base manager, anti poaching coordinator and logistical manager.
...
HTML
          ...
          },
          {
            ...
            cv: <<-HTML
Starting in 2009, Philipp Henschel joined Panthera full-time as the Lion Program Regional Coordinator within West and Central Africa. Originally from Germany, Philipp is now based in Gabon, where he has lived for more than ten years, and from where he currently fulfills his position as Panthera’s Lion Survey Coordinator.

Most recently, Philipp conducted lion field surveys in the Sahelian savannahs of Nigeria and Côte d’Ivoire, and further surveys are planned in Senegal, the Democratic Republic of Congo and Tanzania.
HTML
          },
          {
            name: "Louisa Lombard",
